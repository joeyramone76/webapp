...
image create photo img_dialog_error -data {
...
image create photo img_dialog_info -data {
...
image create photo img_dialog_question -data {
    R0lGODlhIAAgALMAAAAAAAAA/4SEhMbGxvf/Mf//////////////////////
...
image create photo img_dialog_warning -data {
...
image create photo img_dialog_auth -data {
...
image create photo img_dialog_busy -data {
