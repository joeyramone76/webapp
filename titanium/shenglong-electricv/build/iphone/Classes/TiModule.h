...
/**
 The base class for all shenglong_electricv modules
 */
...
/**
 shenglong_electricv Platform calls this method on startup.
 */
-(void)startup;

/**
 shenglong_electricv Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 shenglong_electricv Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 shenglong_electricv Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 shenglong_electricv Platform calls this method on resume.
 @param sender The sender of the event.
 */
