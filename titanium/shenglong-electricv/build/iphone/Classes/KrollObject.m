...
//@interface shenglong_electricvObject : NSObject
//@end

@interface shenglong_electricvObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[shenglong_electricvObject class]])
		{
			for (NSString *key in [[(shenglong_electricvObject*)o modules] allKeys])
			{
