...
//Rare exceptions to indicate a bug in the _shenglong_electricv code (Eg, function that a subclass should have implemented)
...
/**
 The base class for shenglong_electricv proxies.
 */
