...
// in simulator we redefine to format for shenglong_electricv Developer console
...
{\
	NSString * exceptionName = [@"org.shenglong_electricv." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.shenglong_electricv";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIshenglong_electricvNativeItemNone = -1, 
	UIshenglong_electricvNativeItemSpinner = -2,
	UIshenglong_electricvNativeItemProgressBar = -3,
	
	UIshenglong_electricvNativeItemSlider = -4,
	UIshenglong_electricvNativeItemSwitch = -5,
	UIshenglong_electricvNativeItemMultiButton = -6,
	UIshenglong_electricvNativeItemSegmented = -7,
	
	UIshenglong_electricvNativeItemTextView = -8,
	UIshenglong_electricvNativeItemTextField = -9,
	UIshenglong_electricvNativeItemSearchBar = -10,
	
	UIshenglong_electricvNativeItemPicker = -11,
	UIshenglong_electricvNativeItemDatePicker = -12,
	
	UIshenglong_electricvNativeItemInfoLight = -13,
	UIshenglong_electricvNativeItemInfoDark = -14,
	
	UIshenglong_electricvNativeItemDisclosure = -15,
	
	UIshenglong_electricvNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all shenglong_electricv instances of
