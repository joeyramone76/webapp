...
@interface shenglong_electricvObject : KrollCoverageObject {
#else
@interface shenglong_electricvObject : KrollObject {
#endif
@private
...
extern NSString * shenglong_electricv$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	shenglong_electricvObject *_shenglong_electricv;
    KrollObject* console;
	BOOL shutdown;
