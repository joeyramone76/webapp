...
/**
 Base class for all shenglong_electricv views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the shenglong_electricv view hierarchy (such as wrapped iOS UIViews) was touched.
