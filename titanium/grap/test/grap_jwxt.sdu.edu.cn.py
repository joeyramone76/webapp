...
class SDU_Spider:
	...
	def sdu_init(self):
		...
		result = self.opener.open(myRequest); # 访问登录页面，获得cookie信息
		result = self.opener.open(self.resultUrl); # 访问成绩页面，获得成绩数据
		print result.read();
	...
	# 计算成绩，如果成绩还没有出来，或者成绩是优秀良好，就不运算该成绩
