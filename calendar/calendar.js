...
var jieQi = new Array("小寒","大寒","立春","雨水","惊蛰","春分","清明","谷雨","立夏","小满","芒种","夏至","小暑","大暑","立秋","处暑","白露","秋分","寒露","霜降","立冬","小雪","大雪","冬至");
var sTermInfo = new Array(0,21208,42467,63836,85337,107014,128867,150921,173149,195551,218072,240693,263343,285989,308563,331033,353350,375494,397447,419210,440795,462224,483532,504758);
var chineseNumber = new Array('日','一','二','三','四','五','六','七','八','九','十');
var chineseCount = new Array('初','十','廿','卅','□');
...
function calendar(y, m) {
	...
	for(var i=0;i<this.length;i++) {
		...
		this[i] = new calElement(
			y, m + 1, i + 1, chineseNumber[(i + this.firstWeek) % 7],
			lY, lM, lD++, lL,
			cY ,cM, cD
		);
	}
	...
	this[tmp1].solarTerms = jieQi[m * 2];
	this[tmp2].solarTerms = jieQi[m * 2 + 1];
	if(m == 3)
...
function cDay(d) {
	...
	case 30:
		...
		break;
	default :
		s = chineseCount[Math.floor(d / 10)];
		s += chineseNumber[d % 10];
	}
	return(s);
}
...
function drawCld(SY, SM) {
	...
	GZ.innerHTML = yDisplay + '年 农历 ' + cyclical(SY - 1900 + 36) + '年 【' + shengXiao[(SY - 4) % 12] + '年】';
